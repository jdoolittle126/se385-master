...
public class Main {
	...
	public static void main(String[] args) {
		...
		final String message = "The sales commission is ";
		
		salesCommission = newPerson.calculateCommission(0.5f, 100);
		System.out.println(message + salesCommission);
		salesCommission = newPerson.calculateCommission(0.5f, 100.5f);
		System.out.println(message + salesCommission);
		
		//Static method
		double staticSalesCommission;
		staticSalesCommission = SalesPerson.calculateCommission(0.5f, 100d);
		System.out.println(message + staticSalesCommission);
		staticSalesCommission = SalesPerson.calculateCommission(0.5f, 100.5);
		System.out.println(message + staticSalesCommission);
