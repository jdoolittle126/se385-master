...
public class SalesPerson {
	...
	/**
	 * Calculates the commission a sales person earns
	 * @param commissionRate The sales person's commission rate
	 * @param salesAmount The price of the sale
	 * @return The sales person's commission
	 */
	 ...
	 * @return The sales person's commission
	 */
	public static double calculateCommission(float commissionRate, double salesAmount) {
		return commissionRate * salesAmount;
	}
